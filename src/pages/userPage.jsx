...
function UserPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiCallsLeftResponse = await fetch(
        "https://comp-4537-term-project-backend.vercel.app/api-calls",
        {
          method: "GET",
          headers: {
      ...
      const llmResponse = await fetch(
        "https://d155-24-84-205-84.ngrok-free.app/v1/summarize",
        {
          method: "POST",
          headers: {
      ...
      const apiCallsDownResponse = await fetch(
        "http://localhost:8000/v1/api-calls-down",
        {
          method: "PATCH",
          headers: {
      ...
      const updatedApiCallsLeftResponse = await fetch(
        "https://comp-4537-term-project-backend.vercel.app/api-calls",
        {
          method: "GET",
          headers: {
  ...
  return (
    <div className="user-page-container">
      {warningMessage && (
        <div className="warning-banner" color="red">
          {warningMessage}
        </div>
      )}
      ...
      <form onSubmit={handleSubmit}>
        ...
        />
        <button className="user-page-submit" type="submit">
          Submit
        </button>
      </form>
      {isSubmitting ? (
